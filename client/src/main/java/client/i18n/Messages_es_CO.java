...
public class Messages_es_CO extends ListResourceBundle {
    ...
    protected Object[][] getContents(){
        return new Object[][]{
                ...
                { "error.db.permission_denied", "Acceso denegado: El elemento no existe o no te pertenece." },
                ...
                { "console.remove.success", "Accion completada" },
                { "console.chose.worker", "Debes elegir un trabajador"},
                { "console.action.success", "Accion correctamente ejecutada"},

                // --- DESCRIPCIONES (Para el comando Help) ---
                ...
                { "desc.clear", "Vacia completamente la tabla y la colección." },
